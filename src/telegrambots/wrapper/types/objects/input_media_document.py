...
class InputMediaDocument(InputMedia):
    ...
    More info at: https://core.telegram.org/bots/api/#inputmediadocument
    """
    ...
    disable_content_type_detection: Optional[bool] = field(default=None, metadata={
                                                           "ac_type": [bool], "ac_name": "disable_content_type_detection"})
