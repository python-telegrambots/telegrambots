...
class TelegramBotsApiResult(Generic[TResult], TelegramBotsObject):
    ...
    ok: bool = dataclasses.field(metadata={"ac_type": [bool], "ac_name": "ok"})
    """
    :obj:`bool`: True if the request was successful.
    """

    result: Optional[TResult] = dataclasses.field(
        default=None, metadata={"ac_type": [Any], "ac_name": "result"}
    )
    """
    ...
    parameters: Optional[ResponseParameters] = dataclasses.field(
        default=None,
        metadata={"ac_type": [ResponseParameters], "ac_name": "parameters"},
    )
