...
class SetGameScore(TelegramBotsMethod[TelegramBotsApiResult[Optional[Message]]]):
    # --- description here ---
    ...
    force: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "force"}
    )
    """Pass *True*, if the high score is allowed to decrease. This can be useful when fixing mistakes or banning cheaters
    """

    disable_edit_message: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "disable_edit_message"}
    )
    """Pass *True*, if the game message should not be automatically edited to include the current scoreboard
    """

    chat_id: Optional[int] = field(
        default=None, metadata={"ac_type": [int], "ac_name": "chat_id"}
    )
