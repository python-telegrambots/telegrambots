...
class SendAnimation(TelegramBotsMultipartMethod[TelegramBotsApiResult[Message]]):
    # --- description here ---
    """Use this method to send animation files (GIF or H.264/MPEG-4 AVC video without sound). On success, the sent [Message](https://core.telegram.org/bots/api/#message) is returned. Bots can currently send animation files of up to 50 MB in size, this limit may be changed in the future.
    
    More info at: https://core.telegram.org/bots/api/#sendanimation
    """

    def __new__(cls, *args: Any, **kwargs: Any):
        obj = object.__new__(cls)
        TelegramBotsMultipartMethod.__init__(  # type: ignore
            obj, "sendAnimation", [Message])
        return obj
    ...
    animation: InputFile | str = field(metadata={"ac_type": [InputFile, str], "ac_name": "animation"})
