...
class SetMyCommands(TelegramBotsMethodNoOutput):
    # --- description here ---
    ...
    def __new__(cls, *args: Any, **kwargs: Any):
        ...
        TelegramBotsMethodNoOutput.__init__(obj, "setMyCommands")  # type: ignore
        return obj

    # --- arguments here ---
    commands: list[BotCommand] = field(
        metadata={"ac_type": [BotCommand], "ac_name": "commands"}
    )
    """A JSON-serialized list of bot commands to be set as the list of the bot's commands. At most 100 commands can be specified.
    """

    scope: Optional[BotCommandScope] = field(
        default=None, metadata={"ac_type": [BotCommandScope], "ac_name": "scope"}
    )
