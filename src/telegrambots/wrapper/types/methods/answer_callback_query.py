...
class AnswerCallbackQuery(TelegramBotsMethodNoOutput):
    # --- description here ---
    ...
    callback_query_id: str = field(
        metadata={"ac_type": [str], "ac_name": "callback_query_id"}
    )
    ...
    show_alert: bool = field(
        default=False, metadata={"ac_type": [bool], "ac_name": "show_alert"}
    )
...
Otherwise, you may use links like `t.me/your_bot?start=XXXX` that open your bot with a parameter.
    ...
    cache_time: int = field(
        default=0, metadata={"ac_type": [int], "ac_name": "cache_time"}
    )
