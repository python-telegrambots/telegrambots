...
class SendDocument(TelegramBotsMultipartMethod[TelegramBotsApiResult[Message]]):
    # --- description here ---
    """Use this method to send general files. On success, the sent [Message](https://core.telegram.org/bots/api/#message) is returned. Bots can currently send files of any type of up to 50 MB in size, this limit may be changed in the future.
    
    More info at: https://core.telegram.org/bots/api/#senddocument
    """

    def __new__(cls, *args: Any, **kwargs: Any):
        obj = object.__new__(cls)
        TelegramBotsMultipartMethod.__init__(  # type: ignore
            obj, "sendDocument", [Message])
        return obj
    ...
    document: InputFile | str = field(metadata={"ac_type": [InputFile, str], "ac_name": "document"})
    ...
    disable_content_type_detection: Optional[bool] = field(default=None, metadata={"ac_type": [bool], "ac_name": "disable_content_type_detection"})
