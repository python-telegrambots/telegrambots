...
class PromoteChatMember(TelegramBotsMethodNoOutput):
    # --- description here ---
    ...
    def __new__(cls, *args: Any, **kwargs: Any):
        ...
        TelegramBotsMethod.__init__(obj, "promoteChatMember", [bool])  # type: ignore
        return obj
    ...
    is_anonymous: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "is_anonymous"}
    )
    """Pass *True*, if the administrator's presence in the chat is hidden
    """

    can_manage_chat: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "can_manage_chat"}
    )
    ...
    can_delete_messages: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "can_delete_messages"}
    )
    """Pass *True*, if the administrator can delete messages of other users
    """

    can_manage_video_chats: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "can_manage_video_chats"}
    )
    """Pass *True*, if the administrator can manage video chats
    """

    can_restrict_members: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "can_restrict_members"}
    )
    """Pass *True*, if the administrator can restrict, ban or unban chat members
    """

    can_promote_members: Optional[bool] = field(
        default=None, metadata={"ac_type": [bool], "ac_name": "can_promote_members"}
    )
