...
class SendVideoNote(TelegramBotsMultipartMethod[TelegramBotsApiResult[Message]]):
    # --- description here ---
    ...
    More info at: https://core.telegram.org/bots/api/#sendvideonote
    """

    def __new__(cls, *args: Any, **kwargs: Any):
        obj = object.__new__(cls)
        TelegramBotsMultipartMethod.__init__(  # type: ignore
            obj, "sendVideoNote", [Message])
        return obj
    ...
    video_note: InputFile | str = field(metadata={"ac_type": [InputFile, str], "ac_name": "video_note"})
    ...
    length: Optional[int] = field(default=None, metadata={"ac_type": [int], "ac_name": "length"})
